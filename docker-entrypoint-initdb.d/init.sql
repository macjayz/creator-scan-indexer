-- init-db.sql
-- Initialize the database (run by Docker on first start)

-- Create the database (already created by Docker, but ensure)
SELECT 'CREATE DATABASE creator_scan'
WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'creator_scan')\gexec
...
VALUES 
    ('0xc5102fe9359fd9a28f877a67e36b0f050d81a3cc', 'Hop', 'HOP', '0x123...', 'zora_factory', 20000000, 'zora', 'active'),
    ('0x2ae3f1ec7f1f5012cfeab0185bfc7aa3cf0dec22', 'Coinbase Wrapped Staked ETH', 'cbETH', '0x456...', 'uniswap_v3_pool', 20000100, 'unknown', 'active')
